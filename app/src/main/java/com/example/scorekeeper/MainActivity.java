...
public class MainActivity extends AppCompatActivity {
     ...
     */
    public void addWinForPlayer1(View v) {
        ++player1_score;
        displayForPlayer1(player1_score);
    }

    /**
     * Decrease the score for Player 1 by 1 point.
     */
     ...
     */
    public void addWinForPlayer2(View v) {
        ++player2_score;
        displayForPlayer2(player2_score);
    }

    /**
     * Decrease the score for Player 2 by 1 point.
     */
